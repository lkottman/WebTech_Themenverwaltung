...
module.exports = function assertRecordTests(ES, test) {
    test('Property Descriptor', function (t) {
        ...
        forEach(v.nonUndefinedPrimitives, function (primitive) {
            t['throws'](
                function () {
                    assertRecord(ES.Type, record, 'arg', primitive);
                },
                TypeError,
        ...
        t['throws'](
            function () {
                assertRecord(ES.Type, record, 'arg', {invalid: true});
            },
            TypeError,
        ...
        t.doesNotThrow(
            function () {
                assertRecord(ES.Type, record, 'arg', {});
            },
        ...
        t.doesNotThrow(
            function () {
                assertRecord(ES.Type, record, 'arg', v.accessorDescriptor());
            },
        ...
        t.doesNotThrow(
            function () {
                assertRecord(ES.Type, record, 'arg', v.mutatorDescriptor());
            },
        ...
        t.doesNotThrow(
            function () {
                assertRecord(ES.Type, record, 'arg', v.dataDescriptor());
            },
        ...
        t.doesNotThrow(
            function () {
                assertRecord(ES.Type, record, 'arg', v.genericDescriptor());
            },
        ...
        t['throws'](
            function () {
                assertRecord(ES.Type, record, 'arg', v.bothDescriptor());
            },
            TypeError,
